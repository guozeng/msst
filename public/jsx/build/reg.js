			...
			React.createElement("div", null, 
			    ...
			    React.createElement("div", {className: "g-cf"}, 
			      React.createElement("div", {className: "g-fl g-pw70"}, 
			        React.createElement("input", {type: "text", className: "form-control", id: "vcode", placeholder: "验证码"})
			      ), 
			      React.createElement("a", {href: "javascript:;", title: "点击换一个", className: "g-fr reg-vcode"}, React.createElement("img", {src: "/vcode"}))
			    )
			)
		);
	}
